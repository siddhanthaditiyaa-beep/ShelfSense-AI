/* =========================================
   ...
   Multi-tenant + Google OAuth + 40 Agents + Full Security
========================================= */
      ...
      const html = `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="background:#f8fafc;padding:24px;border-radius:0 0 12px 12px;border:1px solid #e2e8f0">
            ...
            <p style="font-size:0.8rem;color:#94a3b8;margin-top:16px">Generated by ShelfSense AI • 40 agents running 24/7</p>
          </div>
        </div>`;
...
const changelog = [
  ...
  { version:"1.0.0", date:"2025-05-01", title:"Initial Release", changes:["40 AI Agents","13 Security Layers","Full SaaS multi-tenant","Google OAuth","Razorpay payments","YOLOv8 shelf scanning","PWA support"] }
];
...
app.get("/system-timeline", (req, res) => {
  res.json({
    timeline: [
      { date: "2025-05-01", version: "1.0.0", title: "Initial Launch", features: ["40 AI Agents", "13 Security Layers", "Full SaaS multi-tenant", "Google OAuth", "Razorpay payments"], agents: 40, security: 13 },
      { date: "2025-05-15", version: "1.5.0", title: "Security & UX Update", features: ["AI Chatbot (Groq)", "NLQ Agent", "Agent Kill Switch", "Notification Centre", "Voice Alerts", "Toast System", "Skeleton Loading"], agents: 40, security: 13 },
  ...
  try {
    ...
    res.json({
      study: [
        ...
        { configuration: "40 Agents", agents: 40, stockoutRate: "4.1%", revenue: (revenue * 0.97).toFixed(0), fraudDetected: 15, automationLevel: "85%", note: "Full original agent suite" },
...
const fullChangelog = [
  ...
  { version:"1.0.0", date:"2025-05-01", highlights:["40 AI Agents","13 Security Layers","YOLOv8 Shelf Scanning","Google OAuth","Razorpay","Multi-tenant SaaS","PWA"] }
];
